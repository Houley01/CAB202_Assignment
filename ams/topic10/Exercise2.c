...
void uart_xmit(unsigned char data)
{
    ...
    UDR1 = data;
    //	a.c End of uart_xmit
}

unsigned char uart_get_char(void)
{
    //	(b) Function uart_get_char must implement the algorithm on
...
void process(void)
{
    ...
    char received_char = uart_get_char();
