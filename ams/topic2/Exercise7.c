...
//  Declare an array called seq with capacity for 27 double precision
...
void array_sum()
{
    ...
    //  seq_len >= 27, or the value returned by scanf is not 1.
    while ((seq_len < 27) && (1 == scanf("%lf", &seq[seq_len])))
    {
        seq_len++;
    }
