...
void process(void)
{
    ...
    else if (BIT_IS_SET(PINB, 7) && cy < LCD_Y - 1)
    {
        cy++;
    }
    ...
    else if (BIT_IS_SET(PIND, 0) && cx < LCD_X - 1)
    {
        cx++;
    }
    ...
    xor_bank(new_bank, (1 << pixel_postion));
